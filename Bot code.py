...
def button_pressed(message):
    ...
    photo_path = 'D:\Картинки для проекта\Командир вас разбудил.png'
...
def handle_choice(message):
    ...
    if state == "start_game":
        if message.text == "Идти к королю сразу":
            ...
            photo_path = 'D:\Картинки для проекта\Король рода людского.png'
            ...
            photo_path = 'D:\Картинки для проекта\Артефакт лучезарность.png' 
            ...
            photo_path = 'D:\Картинки для проекта\Утренние процедуры.png'
        ...
        if message.text == "Да":
            ...
            photo_path = 'D:\Картинки для проекта\Ваш оруженосец.png'
            ...
            photo_path = 'D:\Картинки для проекта\Вы с оруженосцем.png'
            ...
            photo_path = 'D:\Картинки для проекта\Вы с оруженосцем в лесу.jpg'
            caption = "Вы с оруженосцем" 
            with open(photo_path, 'rb') as photo:
                bot.send_photo(message.chat.id, photo, caption=caption)
            time.sleep(25)
            ...
            photo_path = 'D:\Картинки для проекта\Бандиты.jpg'
            caption = "Бандиты" 
            with open(photo_path, 'rb') as photo:
                bot.send_photo(message.chat.id, photo, caption=caption)
            time.sleep(13)
        ...
        if message.text == "Да":
            ...
            photo_path = 'D:\Картинки для проекта\Убегаете.png'
            with open(photo_path, 'rb') as photo:
                bot.send_photo(message.chat.id, photo)
            time.sleep(9)
            ...
            time.sleep(43)
            photo_path = 'D:\Картинки для проекта\Привал в лесу.jpg'
            ...
            time.sleep(45)
            photo_path = 'D:\Картинки для проекта\Мертвый оруженосец.jpg'
            ...
            photo_path = 'D:\Картинки для проекта\Один.jpg'
            with open(photo_path, 'rb') as photo:
                bot.send_photo(message.chat.id, photo)
            time.sleep(25)
        ...
        if message.text == "Заплатить":
            ...
            photo_path = 'D:\Картинки для проекта\паромщик.jpg'
            caption = "Паромщик" 
            with open(photo_path, 'rb') as photo:
                bot.send_photo(message.chat.id, photo, caption=caption)
            time.sleep(5)
            ...
            photo_path = 'D:\Картинки для проекта\упыри.jpg'
        ...
        if message.text == "Да":
            ...
            photo_path = 'D:\Картинки для проекта\Доппельгангер.jpg'
            ...
            photo_path = 'D:\Картинки для проекта\Охранники замка.png'
        ...
        if message.text == "Пойти в лобовую":
            ...
            photo_path = 'D:\Картинки для проекта\Проход в замок.png'
            ...
            photo_path = 'D:\Картинки для проекта\Вы заходите в трофейню комнату.png'
